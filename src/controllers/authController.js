...
class AuthController {
    ...
    // Handle user registration - FIXED
    ...
    static forgotPassword = async (req, res) => {
        try {
            ...
            // Always send generic success message for security
            if (!user) {
    ...
    // Smart dashboard redirect based on user type
    static dashboardRedirect = (req, res) => {
        try {
